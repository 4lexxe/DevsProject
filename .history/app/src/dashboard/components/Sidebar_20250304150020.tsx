...
const Sidebar: React.FC<SidebarProps> = ({ user }) => {
  ...
  const navItems = [
    ...
    // NUEVA SECCIÓN: Herramientas de Desarrollo
    { icon: (size: number) => <Hammer size={size} />, label: 'Dev Tools', isHeader: true, active: false },
    { icon: (size: number) => <Terminal size={size} />, label: 'Sandbox', active: false },
    { icon: (size: number) => <Sliders size={size} />, label: 'Feature Flags', active: false },
    { icon: (size: number) => <Bug size={size} />, label: 'Issue Tracker', active: false },
    { icon: (size: number) => <Zap size={size} />, label: 'Performance', active: false },
    { icon: (size: number) => <LifeBuoy size={size} />, label: 'Dev Support', active: false },
