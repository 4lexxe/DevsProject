  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex-shrink-0 p-3 border-t border-gray-200">
        <a
          href="#"
          className={`flex items-center ${collapsed ? 'py-3 px-4' : 'py-2 px-3'} text-gray-700 rounded-lg hover:bg-gray-100 transition-colors`}
        >
          <div className={`flex items-center justify-center ${collapsed ? 'w-9' : 'w-7'}`}>
