...
import { Clock, BookOpen, GraduationCap, ArrowRight, Star, Users, PlayCircle, Sparkles } from "lucide-react";
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <div className="px-2 py-1 bg-green-500 text-white rounded-full text-xs font-bold">
            Nuevo
          </div>
        </div>
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <h3 className="text-lg font-bold text-gray-900 leading-tight line-clamp-2 group-hover:text-blue-600 transition-colors flex-1">
            {title}
          </h3>
