...
import { LogOut, User, Settings, LogIn, UserPlus, CreditCard, Search, Bell, BookOpen, Users, Route, FolderOpen } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NavLink href="/plans" icon={<Users className="w-4 h-4" />}>
              Planes
            </NavLink>
