...
const CourseListItem: React.FC<CourseListItemProps> = ({ id, title, summary, categories, image, careerType }) => {
  return (
    ...
    >
      {/* Thumbnail mejorado para móvil */}
      <div className="relative w-28 sm:w-36 md:w-44 flex-shrink-0"> 
        <div className="w-full p-1 bg-white shadow-sm rounded-lg">
          <div className="relative w-full h-20 sm:h-24 md:h-28 overflow-hidden rounded-md">
            <img
