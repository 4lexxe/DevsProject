...
const ResourceListPage: React.FC = () => {
  ...
  const fetchResources = useCallback(async () => {
    try {
      ...
      // Como estamos usando la versión pública, los recursos ya incluyen la información del usuario
      ...
      // Los recursos públicos ya incluyen la información del usuario, extraerla directamente
