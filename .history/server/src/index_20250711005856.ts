...
const startServer = async () => {
  try {
    ...
    const server = app.listen(PORT, () => {
      ...
      console.log('   📚 Recursos: http://localhost:3000/api/resources');
      console.log('   👤 Usuarios: http://localhost:3000/api/users/public');
      console.log('   🔐 Auth: http://localhost:3000/api/auth');
      console.log('   📊 Estado: http://localhost:3000/api/status');
    });
