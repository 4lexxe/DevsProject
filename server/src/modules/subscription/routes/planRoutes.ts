...
router.get('/plans/active', PlanController.getDefaultPlans); // Obtener todos los planes activos
router.get('/plans/:id', PlanController.getById); // Obtener un plan por ID
router.get('/plans/:id/subscription', PlanController.getByIdForSubscription); // Obtener un plan por ID
