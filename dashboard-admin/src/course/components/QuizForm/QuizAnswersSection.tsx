      ...
      <Controller
        ...
        render={({ field }) => (
          <div className="space-y-3">
            ...
            {/* Información contextual sobre las respuestas */}
            <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">Consejos para las respuestas</h3>
                  <div className="mt-1 text-sm text-blue-700">
                    <ul className="list-disc list-inside space-y-1">
                      <li>Proporciona explicaciones para ayudar a los estudiantes a entender</li>
                      <li>Marca claramente qué respuestas son correctas</li>
                      <li>Asegúrate de tener al menos una respuesta por pregunta</li>
                      <li>Las explicaciones aparecerán después de que el estudiante responda</li>
                    </ul>
                  </div>
                </div>
              </div>
