        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600">Lista para enviar</span>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="text-yellow-700 text-sm mt-1">
                Agrega al menos una pregunta antes de guardar el quiz. Cada
                pregunta debe tener al menos una respuesta.
              </p>
            </div>
          </div>
        </div>
