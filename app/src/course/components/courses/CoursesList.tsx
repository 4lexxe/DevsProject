      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          {courses === null || courses === undefined ? (
            ...
            <p className="text-center py-8 text-gray-600">No se encontraron cursos.</p>
          ) : (
            courses.map((course) => <CourseListItem key={course.id} {...course} categories={course.categories} />)
          )}
        </div>
      </div>
    </section>
